public class Main {
  ...
  public static void printKindOfYear(int y) {
    if (y % 100 == 0 && y % 400 == 0) {
      System.out.println("Високосный год");

    } else if (y % 4 == 0 && y % 100 != 0) {
      System.out.println("Високосный гaод");
    } else {
      System.out.println("Невисокосный год");
    }
  }
  public static void version(int x, int y) {
